...
namespace PixelBurguer.Migrations
{
    ...
    public partial class AddSnacks : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO Snacks(CategoryId,SnackDescriptionShort,SnackDescriptionLong,IsSnackAvailable,ImageThumbnailUrl,ImageUrl,IsSnackFavorite,SnackName,SnackPrice) VALUES(1,'Pão, presunto, mussarela e tomate','Delicioso pão francês quentinho na chapa com presunto e mussarela bem servidos com tomate preparado com carinho.',1,'http://www.macoratti.net/Imagens/lanches/mistoquente4.jpg','http://www.macoratti.net/Imagens/lanches/mistoquente4.jpg',0,'Misto Quente', 8.00)");
            ...
            migrationBuilder.Sql("INSERT INTO Snacks(CategoryId,SnackDescriptionShort,SnackDescriptionLong,IsSnackAvailable,ImageThumbnailUrl,ImageUrl,IsSnackFavorite,SnackName,SnackPrice) VALUES(2,'Pão Integral, queijo branco, peito de peru, cenoura, alface, iogurte','Pão integral natural com queijo branco, peito de peru e cenoura ralada com alface picado e iorgurte natural.',1,'http://www.macoratti.net/Imagens/lanches/lanchenatural.jpg','http://www.macoratti.net/Imagens/lanches/lanchenatural.jpg',1,'Lanche Natural Peito Peru', 15.00)");
        }
